 ...
 */
if (!function_exists('pp_capabilities_sanitize_entry')) {
...
if (!function_exists('pp_capabilities_is_editable_role')) {
...
if (!function_exists('_cme_act_pp_active')) {
...
if (!function_exists('_cme_cap_helper')) {
...
if (!function_exists('_cme_post_type_late_reg')) {
...
if (!function_exists('_cme_taxonomy_late_reg')) {
...
if (!function_exists('cme_is_plugin_active')) {
...
if (!function_exists('_cme_pp_default_pattern_role')) {
...
// deprecated
if (!function_exists('capsman_get_pp_option')) {
...
if (!function_exists('pp_capabilities_get_permissions_option')) {
...
if (!function_exists('pp_capabilities_update_permissions_option')) {
 ...
 */
if (!function_exists('pp_capabilities_get_post_type')) {
 ...
 * @return bool
 */
if (!function_exists('pp_capabilities_is_classic_editor_available')) {
 ...
 *
 */
if (!function_exists('ppc_admin_feature_restrictions')) {
 ...
 * @return void
 */
if (!function_exists('ppc_test_user_init')) {
 ...
 * @return void
 */
if (!function_exists('ppc_admin_notices_init')) {
 ...
 */
if (!function_exists('ppc_role_redirect_after_registration')) {
 ...
 * @return string
 */
if (!function_exists('woocommerce_registration_redirect')) {
 ...
 * @return string
 */
if (!function_exists('ppc_roles_login_redirect')) {
        ...
        if (pp_capabilities_feature_enabled('redirects') && isset($user->roles) && is_array($user->roles)) {
            ...
            foreach ($user->roles as $user_role) {
                ...
                if ($is_first_login === '' && is_array($role_option) && !empty($role_option) && !empty($role_option['first_login_redirect'])) {
                    ...
                    is_array($role_option) && !empty($role_option)
 ...
 * @return string
 */
if (!function_exists('ppc_roles_woocommerce_login_redirect')) {
 ...
 * @return void
 */
if (!function_exists('ppc_roles_last_visited_page_cookie')) {
 ...
 * @return string
 */
if (!function_exists('ppc_roles_logout_redirect')) {
 ...
 */
if (!function_exists('ppc_roles_wp_authenticate_user')) {
 ...
 */
if (!function_exists('ppc_roles_disable_woocommerce_admin_restrictions')) {
 ...
 *
 */
if (!function_exists('pp_capabilities_admin_pages')) {
 ...
 *
 */
if (!function_exists('is_pp_capabilities_admin_page')) {
...
if (!function_exists('pp_capabilities_nav_menu_access_denied')) {
 ...
 * @return void
 */
if (!function_exists('pp_capabilities_sidebox_banner')) {
 ...
 * Load pro sidebar
 */
if (!function_exists('pp_capabilities_pro_sidebox')) {
 ...
 * @return bool
 */
if (!function_exists('pp_capabilities_is_block_theme')) {
 ...
 * @return array
 */
if (!function_exists('pp_capabilities_get_fse_navs')) {
 ...
 * @return array
 */
if (!function_exists('pp_capabilities_get_fse_navs_sub_items')) {
 ...
 */
if (!function_exists('pp_capabilities_parse_nav_block')) {
...
if (!function_exists('ppc_block_friend_name')) {
...
if (!function_exists('ppc_block_menu_icon')) {
    function ppc_block_menu_icon($block_name)
    {

        return '<i class="dashicons dashicons-arrow-right"></i>';
...
if (!is_admin()) {
     ...
     * @return array
     */
    if (!function_exists('pp_capabilities_nav_menu_permission')) {
     ...
     * @return array
     */
    if (!function_exists('pp_capabilities_fse_nav_menu_permission')) {
     ...
     */
    if (!function_exists('ppc_block_core_page_list_nest_pages')) {
     ...
     *
     */
    if (!function_exists('pp_capabilities_nav_menu_access')) {
 ...
 * @return string
 */
if (!function_exists('pp_capabilities_nav_link_selector')) {
 ...
 * @return string
 */
if (!function_exists('pp_capabilities_current_url')) {
 ...
 * @return bool
 */
if (!function_exists('pp_capabilities_feature_enabled')) {
    function pp_capabilities_feature_enabled($feature)
    {
        ...
        if (
            isset($capsman_dashboard_features_status[$feature])
