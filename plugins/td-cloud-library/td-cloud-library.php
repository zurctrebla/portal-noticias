 ...
 * also registered on 'setup_theme' (fires after $wp_rewrite is created but before theme functions.php loads tdc_main.php)
 * to ensure tdb_templates is registered before any capability checks on tdc_edit action (map_meta_cap notice fix)
 */
add_action( 'setup_theme', 'tdb_on_init_cpt', 0 );
add_action( 'init', 'tdb_on_init_cpt', 0 );
