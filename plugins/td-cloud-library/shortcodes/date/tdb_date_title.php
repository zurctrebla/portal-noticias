...
/**
 * Class tdb_date_title
 */

class tdb_date_title extends td_block {
    ...
    function render( $atts, $content = null ) {
        ...
        $date_title_data = $tdb_state_date->title->__invoke( $atts );
...
//        $buffy = '<pre>';
//        $buffy .= print_r($date_title_data['date_query'], true);
//        $buffy .= '</pre>';
        ...
        $buffy .= '<div class="' . $this->get_block_classes() . '" ' . $this->get_block_html_atts() . '>';
            ...
            $buffy .= '<div class="tdb-block-inner td-fix-index">';
                ...
                $buffy .= '<' . $title_tag . ' class="tdb-single-tag-text"><span class="tdb-add-text">' . $this->get_att('add_text') . '</span> ' . $date_title_data['title'] . '</' . $title_tag . '>';
