                ...
                $buffy .= '<div class="tdb-author-socials">';
                    if ( !empty( $author_socials_data['social_icons'] ) ) {
                        foreach ( $author_socials_data['social_icons'] as $author_socials_data ) {
                            $buffy .= '<a href="' . $author_socials_data['social_link'] . '"' . $td_social_rel . ' target="_blank" title="' . $author_socials_data['social_name'] . '" class="tdb-social-item">';
                                $buffy .= '<i class="td-icon-font td-icon-' . $author_socials_data['social_id'] . '"></i>';
                                $buffy .= '<span class="tdb-social-text">' . ( $author_socials_data['social_id'] == 'mail-1' ? 'mail' : $author_socials_data['social_id'] ) . '</span>';
                            $buffy .= '</a>';
                        }
                    }
                $buffy .= '</div>';
