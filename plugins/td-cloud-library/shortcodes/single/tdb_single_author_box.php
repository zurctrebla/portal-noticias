...
class tdb_single_author_box extends td_block {
    ...
    function render( $atts, $content = null ) {
        ...
        $buffy = ''; //output buffer
        if ( !empty($author_box_data['author_name']) ) {
            ...
            if (!empty($author_box_data['author_social_icons'])) {
                foreach ($author_box_data['author_social_icons'] as $td_social_icon) {
                    $buffy .= '<a href="' . $td_social_icon['social_link'] . '"' . $td_social_rel . ' target="_blank" title="' . $td_social_icon['social_name'] . '" class="tdb-social-item">';
