...
class tdb_attachment_pag_prev extends td_block {
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                ...
                /* @style_general_attachment_pag_prev */
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $res_ctx->load_settings_raw( 'style_general_attachment_pag_prev', 1 );
    ...
    function render( $atts, $content = null ) {
        ...
        $attachment_img_pag_data = $tdb_state_attachment->attachment_pag_prev->__invoke( $atts );
