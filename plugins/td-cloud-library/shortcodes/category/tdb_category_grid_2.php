...
class tdb_category_grid_2 extends td_block {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $res_ctx->load_settings_raw( 'style_general_cat_bgf_2_specific', 1 );
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                /* @style_general_cat_bgf_2_specific */
				...
				/* @image_height1 */
				.$unique_block_class [class^='tdb_module_cat_grid_1'] .td-image-wrap {
