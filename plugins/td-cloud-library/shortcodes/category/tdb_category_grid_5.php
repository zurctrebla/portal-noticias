...
class tdb_category_grid_5 extends td_block {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $res_ctx->load_settings_raw( 'style_general_cat_bgf_5_specific', 1 );
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                /* @style_general_cat_bgf_5_specific */
				...
				/* @video_icon3 */
				.$unique_block_class .tdb_module_cat_grid_3 .td-video-play-ico {
					width: @video_icon3;
					height: @video_icon3;
				...
				/* @show_review3 */
				.$unique_block_class .tdb_module_cat_grid_3 .entry-review-stars {
					display: @show_review3;
				}
				/* @review_size3 */
				.$unique_block_class .tdb_module_cat_grid_3 .td-icon-star,
                .$unique_block_class .tdb_module_cat_grid_3 .td-icon-star-empty,
                .$unique_block_class .tdb_module_cat_grid_3 .td-icon-star-half {
