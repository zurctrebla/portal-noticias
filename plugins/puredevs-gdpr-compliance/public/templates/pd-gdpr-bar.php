...
$banner_text_font_size = isset($pd_banner_settings['banner_text_font_size']) ? $pd_banner_settings['banner_text_font_size'] : '';
if( !empty( $banner_text_font_size ) ){
    $banner_text_font_size = intval( $banner_text_font_size );
}

$banner_background_opacity = isset($pd_banner_settings['banner_background_opacity']) ? $pd_banner_settings['banner_background_opacity'] : '';
