                                                        ...
                                                        if ( $this->strictly_necessary_cookies_section['snc_choose_functionality'] != 'always-enable' ) : ?>
                                                            <div class="pd-gdpr-row  align-items-center">
                                                                <div class="col-sm-12 ">
                                                                    ...
                                                                    <label class="custom-toggle re-custom">
																		<input type="checkbox" data-cookie-category="pd_strictly_necessary_cookie" <?php echo (isset($_COOKIE['pd_strictly_necessary_cookie']) && $_COOKIE['pd_strictly_necessary_cookie'] === 'true' ) ? 'checked' : ''; ?>>
                                                                        <span class="custom-toggle-slider"></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="pd-gdpr-row  align-items-center">
                                                            <div class="col-sm-12 ">
                                                                ...
                                                                <label class="custom-toggle re-custom">
		                                                            <?php
		                                                            $checked = '';
																	if ( isset($_COOKIE['pd_3rd_party_cookie']) && $_COOKIE['pd_3rd_party_cookie'] == '' && $this->third_party_cookies_section['enable_disable_3rd_party_cookie'] == 'on' ) {
			                                                            $checked = 'checked';
		                                                            } elseif ( isset($_COOKIE['pd_3rd_party_cookie']) && $_COOKIE['pd_3rd_party_cookie'] == 'true' && ( $this->third_party_cookies_section['enable_disable_3rd_party_cookie'] == 'on' || $this->third_party_cookies_section['enable_disable_3rd_party_cookie'] == 'off' ) ) {
			                                                            $checked = 'checked';
		                                                            }
		                                                            ?>
                                                    ...
                                                    <div class="list hide" id="tabs-add-cookie-tab">
                                                        ...
                                                        <div class="pd-gdpr-row  align-items-center">
                                                            <div class="col-sm-12 ">
                                                                <small class="pd-gdpr-label "><?php echo esc_html__('Enable', 'pd_gdpr')?></small>
                                                                <label class="custom-toggle re-custom">
																	<input type="checkbox" data-cookie-category="pd_additional_cookie" <?php echo ( ! empty( $this->additional_cookies_section['enable_disable_additional_cookie'] ) && ( ( isset($_COOKIE['pd_additional_cookie']) && $_COOKIE['pd_additional_cookie'] == '' && $this->additional_cookies_section['enable_disable_additional_cookie'] == 'on' ) || ( isset($_COOKIE['pd_additional_cookie']) && $_COOKIE['pd_additional_cookie'] == 'true' && $this->additional_cookies_section['enable_disable_additional_cookie'] == 'on' ) || ( isset($_COOKIE['pd_additional_cookie']) && $_COOKIE['pd_additional_cookie'] == 'true' && $this->additional_cookies_section['enable_disable_additional_cookie'] == 'off' ) ) ) ? 'checked' : '' ?>>
                                                                    <span class="custom-toggle-slider"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="list hide" id="tabs-required-tab">
                                                        ...
                                                        <div class="pd-gdpr-row  align-items-center">
                                                            <div class="col-sm-12 ">
                                                                <small class="pd-gdpr-label "><?php echo esc_html__('Enable', 'pd_gdpr');?></small>
                                                                <label class="custom-toggle re-custom">
																	<input type="checkbox" data-cookie-category="pd_required_cookie" <?php echo ( ! empty( $this->required_cookies_section['enable_disable_required_cookies'] ) && ( ( isset($_COOKIE['pd_required_cookie']) && $_COOKIE['pd_required_cookie'] == '' && $this->required_cookies_section['enable_disable_required_cookies'] == 'on' ) || ( isset($_COOKIE['pd_required_cookie']) && $_COOKIE['pd_required_cookie'] == 'true' && $this->required_cookies_section['enable_disable_required_cookies'] == 'on' ) || ( isset($_COOKIE['pd_required_cookie']) && $_COOKIE['pd_required_cookie'] == 'true' && $this->required_cookies_section['enable_disable_required_cookies'] == 'off' ) ) ) ? 'checked' : '' ?>>
                                                                    <span class="custom-toggle-slider"></span>
                                                                </label>
                                                            </div>
                                                        </div>
