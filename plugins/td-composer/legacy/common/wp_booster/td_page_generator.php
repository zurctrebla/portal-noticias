    ...
    static private function render_infinite_pagination() {
        ...
        if(!is_admin() and td_global::get_current_template() !== 'page-homepage-loop' and is_category() and !empty($wp_query)) {
            ...
            if ($pagination_style != '') {
                ...
                if( TD_THEME_NAME == "Newspaper" && ( $pagination_style != '' && $pagination_style != 'normal' ) ) {
                    ...
                    td_resources_load::render_script( TDC_SCRIPTS_URL . '/tdLoopAjax.js' . TDC_SCRIPTS_VER, 'tdLoopAjax-js', '', 'footer');
                }
                ob_start();
                ?>
                <script>
