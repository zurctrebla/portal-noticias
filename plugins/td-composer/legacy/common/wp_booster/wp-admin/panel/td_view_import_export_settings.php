...
<div class="td-container-wrap">
	...
	<div class="td-panel-main-header">
        ...
        <div class="td-panel-header-desc">
            <span class="td-panel-header-name"><?php echo td_util::get_wl_val('tds_wl_theme_name', TD_THEME_NAME) . ' - Theme panel'; ?></span>
                    ...
                    <input type="hidden" name="action" value="td_ajax_update_panel">
                        ...
                        <div class="td-box-row td-import-settings-col-2">
                            <div class="td-box-description td-box-full">
                                ...
                                <span class=" td-box-title td-title-on-row">Backups limit
                                <?php td_util::tooltip_html('
                                        <ul>
                                        <li>This option allows you to set the backups limit to be stored into the database. </li>
                                        <li>The backups number will be reflected into the database on the next Save Settings action.</li>
                                        </ul>
                                    ', 'right')?>
                                </span>
                                <?php
                                    ...
                                    (function(){
                                        jQuery().ready(function() {
                                            ...
                                            var $tdBackupSelect = jQuery('.td-select-style-overwrite.td_tp_backup_limit'),
                                                $tdBackupLimit = $tdBackupSelect.find( 'select[name^="td_option[td_tp_backup_limit"]' );
