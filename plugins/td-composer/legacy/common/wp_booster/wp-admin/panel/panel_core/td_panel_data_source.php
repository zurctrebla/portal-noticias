...
//                    break;
    ...
    private static function update_wp_theme_mod($wp_option_array) {
        ...
        // get defaults array
        $default_array = $_POST['td_default'] ?? array();
    ...
    private static function update_td_option($td_option_array) {
        ...
        foreach( $td_option_array as $options_id => $option_value ) {
            ...
            $old_option_value = !empty($td_options[$options_id]) ? $td_options[$options_id] : null;
            do_action('td_panel_option_updated', $options_id, $old_option_value, $option_value);
