...
<?php if (TD_THEME_NAME === 'Newspaper') { ?>
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <span class="td-box-title">SHOW SIDEBAR IN CLASSIC EDITOR</span>
            <p>Show the sidebar column indicator in the classic (TinyMCE) post editor.</p>
            <p>When enabled, the editor canvas narrows to reflect the sidebar layout and displays a visual sidebar marker.</p>
        </div>
        <div class="td-box-control-full">
            <?php
            echo td_panel_generator::checkbox(array(
                'ds' => 'td_option',
                'option_id' => 'tds_editor_show_sidebar',
                'true_value' => 'yes',
                'false_value' => ''
            ));
            ?>
