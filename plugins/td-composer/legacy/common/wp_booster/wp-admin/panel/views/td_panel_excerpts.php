...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">SHOW LINKS IN EXCERPTS</span>
        <p>This option can be disabled when working with links positioned at the beginning of post content.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::checkbox(array(
            'ds' => 'td_option',
            'option_id' => 'tds_m_show_links_in_excerpt',
            'true_value' => '',
            'false_value' => 'hide'
        ));
        ?>
