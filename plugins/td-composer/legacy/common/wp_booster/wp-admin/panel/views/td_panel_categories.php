...
if( 'Newsmag' == TD_THEME_NAME || ( 'Newspaper' == TD_THEME_NAME && defined('TD_STANDARD_PACK') ) ) { ?>
    ...
    <div class="td-box-row tdb-hide">
            <div class="td-box-description">
                ...
                <p>Select a module type, this is how your article list will be displayed. <?php echo ('enabled' !== td_util::get_option('tds_white_label')) ? 'For custom modules or tuning, read <a target="_blank" href="http://forum.tagdiv.com/api-modules-introduction/">the module API</a>' : '' ?></p>
            </div>
