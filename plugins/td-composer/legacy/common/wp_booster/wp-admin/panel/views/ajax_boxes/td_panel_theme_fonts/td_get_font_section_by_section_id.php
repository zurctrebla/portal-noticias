...
class td_panel_custom_typography_ajax {
    ...
    var $typography_settings_list;
    var $td_fonts_db_option_name;
    ...
    function __construct($post = '') {
        ...
        //set typography settings list
        $this->set_typography_settings_list();
    }
    ...
    public function set_typography_settings_list() {
	    $this->typography_settings_list = td_global::$typography_settings_list;
	    $this->td_fonts_db_option_name = 'td_fonts';
    }
