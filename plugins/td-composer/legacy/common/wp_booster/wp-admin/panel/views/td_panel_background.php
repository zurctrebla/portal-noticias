...
<?php if( 'Newsmag' == TD_THEME_NAME || ( 'Newspaper' == TD_THEME_NAME  && ( defined('TD_STANDARD_PACK') || td_global::is_tdb_registered() ) ) ) {
    echo td_panel_generator::box_start('Sign in/Join background', false); ?>

    <!-- BACKGROUND UPLOAD -->
    <div class="td-box-row">
        <div class="td-box-description td-box-full">
            <span class="td-box-title">Instructions:</span>
            <p>If you are using a background image, go to <strong>Theme Colors ⇢ Sign in/Join</strong> and adjust the
                <strong>opacity</strong> for the <strong>Background Gradient Color</strong></p>
        </div>
        <div class="td-box-row-margin-bottom"></div>
        <div class="td-box-description">
            <span class="td-box-title">BACKGROUND IMAGE</span>
