...
/*
define('YOUR_CONSUMER_KEY', 'zhPQJqyZmCu4Zko5kEqDkw');
define('YOUR_CONSUMER_SECRET', 'ka0zVIioPVGJ44qhvDj3APSSfoS0WbvYM98FKjxV0k');
define('SOME_ACCESS_KEY', '890610409-HxxCsHmA6BvIwP8j0dBdtG0BzndUAHy9My1zD4hk');
define('SOME_ACCESS_SECRET', 'Dr2Je1rpeLitq0ub81L1bAyLScAiX2yasEFwMjRSLg');
*/


define('YOUR_CONSUMER_KEY', 'Nbq9WGD3Zf06k7ZPXSjpq07Qk');
define('YOUR_CONSUMER_SECRET', '8Alzy97ncMlVQApvxKfGpmykIwLI87EK90jnNmwjRBBtpB9Mnq');
define('SOME_ACCESS_KEY', '811898918267211776-RyiPsypCfYu18OBqV3w9jc0DaGNTuso');
define('SOME_ACCESS_SECRET', 'TYXhENQWQYHPpkaxv1ISUrYgHh5G4TLNwigXDKSHeWTGr');
...
//        die('this is the args value');
    ...
    public static function http_request( $endpoint, array $conf ){
        ...
        $ch = curl_init();
        // fix curl "error setting certificate verify locations: .."
...
class TwitterOAuthParams {
    ...
    public function sign_hmac( $http_method, $http_rsc ){
        ...
        if ( td_util::tdc_is_installed() ) {
	        $this->args['oauth_signature'] = tdc_b64_encode( hash_hmac( 'sha1', $str, $key, true ) );
        }
        return $this->args;
    }
