        ...
        if (!isset(self::$components_list[$id])) {
            ...
            if (($id == 'td_social_counter' or $id == 'td_block_social_counter')) {
                if (is_user_logged_in()) {
                    $brand = td_util::get_wl_val('tds_wl_brand', 'tagDiv');

                    td_util::error('', "Please update your [$brand social counter] Plugin!");
                }
                return;
            }
...
class td_api_category_template extends td_api_base {
    ...
    static function render_category_template_by_id($template_id) {
        if (class_exists($template_id)) {
            ...
            $brand = td_util::get_wl_val('tds_wl_brand', 'tagDiv');
	        td_util::error( __FILE__, "The category template $template_id doesn't exist. Did you disable a $brand plugin?" );
...
class td_api_footer_template extends td_api_base {
    ...
    static function _helper_show_footer() {
        ...
        try {
            ...
            td_util::error( __FILE__, "td_api_footer_template::_helper_show_footer : $template_id isn't set. Did you disable a $brand plugin?" );  //does not stop execution
	        td_util::set_check_installed_plugins();
        }
...
class td_api_sub_footer_template extends td_api_base {
    ...
    static function _helper_show_sub_footer() {
        ...
        try {
            ...
            td_util::error( __FILE__, "td_api_sub_footer_template::_helper_show_sub_footer : $template_id isn't set. Did you disable a $brand plugin?" );  //does not stop execution
	        td_util::set_check_installed_plugins();
        }
...
class td_api_header_style extends td_api_base {
    ...
    static function show_header() {
        ...
        try {
            ...
            td_util::error( __FILE__, "The header style: $tds_header_style isn't set. Did you disable a $brand plugin?" );  //does not stop execution
	        td_util::set_check_installed_plugins();
        }
        ...
        if (!empty($template_path) and file_exists($template_path)) {
            ...
            td_util::error( __FILE__, "The path $template_path of the $tds_header_style header style not found. Did you disable a $brand plugin?" );
	        td_util::set_check_installed_plugins();
        }
    }
...
class td_api_single_template extends td_api_base {
    ...
    static function _get_theme_template($single_template_id, $wordpress_template_path) {
        ...
        try {
            ...
            td_util::error( __FILE__, "The template $single_template_id isn't set. Did you disable a $brand plugin?" ); // this does not stop execution
            td_util::set_check_installed_plugins();
            return $wordpress_template_path;
        }
        ...
        if (!empty($single_template_path) and file_exists($single_template_path)) {
            ...
            td_util::error( __FILE__, "The path $single_template_path of the $single_template_id template not found. Did you disable a $brand plugin?" );  // this does not stop execution
            td_util::set_check_installed_plugins();
            return $wordpress_template_path;
        }
    }
    ...
    static function _helper_show_single_template($template_id) {
        ...
        try {
            ...
            td_util::error( __FILE__, "The template $template_id isn't set. Did you disable a $brand plugin?" ); // this does not stop execution
	        td_util::set_check_installed_plugins();
        }
...
class td_api_top_bar_template extends td_api_base {
    ...
    static function _helper_show_top_bar() {
        ...
        try {
            ...
            td_util::error( __FILE__, "td_api_top_bar_template::_helper_show_top_bar : $template_id isn't set. Did you disable a $brand plugin?" );  //does not stop execution
	        td_util::set_check_installed_plugins();
        }
