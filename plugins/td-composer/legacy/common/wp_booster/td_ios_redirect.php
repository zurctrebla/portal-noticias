...
if ( typeof window.tdb_p_autoload_vars.autoloadStatus !== 'undefined' && window.tdb_p_autoload_vars.autoloadStatus === 'on' ) {
    tdb_post_autoload = true;
}

if ( typeof window.tdb_p_autoload_vars.isAjax !== 'undefined' && window.tdb_p_autoload_vars.isAjax ) {
    tdb_is_ajax = true;
}
