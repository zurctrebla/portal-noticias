...
class td_global {
	...
	// Flag set in tdb_module_template
	private static $in_tdb_module_template = false;


    // Flag set in tdm_block_popup
    private static $in_tdm_block_popup = false;


    // Flag set in td_block_page_content_renderer
    private static $in_td_block_page_content_renderer = false;

    private static $td_aib_section = null;
	...
	/**
	 * Set the $in_tdb_module_template
	 *
	 * @param $in_tdb_module_template
	 */
	static function set_in_tdb_module_template($in_tdb_module_template) {
		self::$in_tdb_module_template = $in_tdb_module_template;
	}

	/**
	 * Just get the $in_tdb_module_template flag
	 * @return bool
	 */
	static function get_in_tdb_module_template() {
		return self::$in_tdb_module_template;
	}


    /**
     * Set the $in_tdm_block_popup
     *
     * @param $in_tdm_block_popup
     */
    static function set_in_tdm_block_popup($in_tdm_block_popup) {
        self::$in_tdm_block_popup = $in_tdm_block_popup;
    }

    /**
     * Just get the $in_tdm_block_popup flag
     * @return bool
     */
    static function get_in_tdm_block_popup() {
        return self::$in_tdm_block_popup;
    }


    /**
     * Set the $in_td_block_page_content_renderer
     *
     * @param $in_td_block_page_content_renderer
     */
    static function set_td_block_page_content_renderer($in_td_block_page_content_renderer) {
        self::$in_td_block_page_content_renderer = $in_td_block_page_content_renderer;
    }

    /**
     * Just get the $in_td_block_page_content_renderer flag
     *
     * @return bool
     */
    static function get_td_block_page_content_renderer() {
        return self::$in_td_block_page_content_renderer;
    }
     ...
     */
    static function set_td_aib_section( $options ) {
        self::$td_aib_section = $options;
    }
     ...
     * @return object|null
     */
    static function get_td_aib_section() {
        return self::$td_aib_section;
    }
	...
	/**
	 * the list of pages used as mega menu
	 * @var array
	 */
	public static $mega_menu_pages_ids = array();
