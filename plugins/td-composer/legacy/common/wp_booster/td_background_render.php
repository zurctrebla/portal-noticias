    ...
    function __construct($background_parameters) {
        ...
        if (!empty($this->background_parameters['theme_bg_image']) and $this->background_parameters['is_stretched_bg'] == true) {
            if( TD_THEME_NAME == "Newspaper" ) {
                ...
                td_resources_load::render_script( TDC_SCRIPTS_URL . '/tdBackstr.js' . TDC_SCRIPTS_VER, 'tdBackstr-js', '', 'footer' );
            }
            ...
            <script>
                ...
                if ( 'undefined' !== typeof window.tdBackstr ) {
                    ...
                    (function(){
                        ...
                        var image_jquery_obj = jQuery( '<img class=\'td-backstretch not-parallax\' src=\'<?php echo esc_url( $this->background_parameters['theme_bg_image'] ) ?>\' <?php echo $this->background_parameters['theme_bg_alt'] ?>>' );
