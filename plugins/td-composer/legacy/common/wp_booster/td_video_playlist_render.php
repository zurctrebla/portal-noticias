...
//            }
            ...
            if( TD_THEME_NAME == "Newspaper" ) {
                switch( $list_type ) {
                    case 'youtube':
                        td_resources_load::render_script( TDC_SCRIPTS_URL . '/tdVideoPlaylistYoutube.js' . TDC_SCRIPTS_VER, 'tdVideoPlaylistYoutube-js', '', 'footer' );
                        break;

                    case 'vimeo':
                        td_resources_load::render_script( TDC_SCRIPTS_URL . '/vimeo_froogaloop.js' . TDC_SCRIPTS_VER, 'vimeo_froogaloop-js', '', 'footer' );
                        td_resources_load::render_script( TDC_SCRIPTS_URL . '/tdVideoPlaylistVimeo.js' . TDC_SCRIPTS_VER, 'tdVideoPlaylistVimeo-js', '', 'footer' );
                        break;
                }
            }
