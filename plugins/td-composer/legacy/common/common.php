...
td_api_autoload::add('td_resources_load', TDC_PATH . '/legacy/common/wp_booster/td_resources_load.php');
        ...
        if ( !empty( $tdb_template_id ) ) {
            ...
            if ( ! empty( $wp_query_template ) && $wp_query_template->have_posts() ) {
                ...
                if ( ! empty( $content_width )) {
                	echo '<style>/* custom css - generated by TagDiv Composer */ .td-gutenberg-editor .editor-styles-wrapper .wp-block {max-width: ' . $content_width . 'px}</style>';
