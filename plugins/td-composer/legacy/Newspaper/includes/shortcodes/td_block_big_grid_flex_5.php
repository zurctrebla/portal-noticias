...
class td_block_big_grid_flex_5 extends td_block {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $res_ctx->load_settings_raw( 'style_general_bgf_5_specific', 1 );
        ...
        $review_space3 = $res_ctx->get_shortcode_att('review_space3');
        $res_ctx->load_settings_raw( 'review_space3', $review_space3 );
        if( $review_space3 != '' && is_numeric( $review_space3 ) ) {
            $res_ctx->load_settings_raw( 'review_space3', $review_space3 . 'px' );
        }
        $review_size3 = $res_ctx->get_shortcode_att('review_size3');
        $res_ctx->load_settings_raw( 'review_size3', 10 + $review_size3/0.5 . 'px' );
        $review_distance3 = $res_ctx->get_shortcode_att('review_distance3');
        $res_ctx->load_settings_raw( 'review_distance3', $review_distance3 );
        if( $review_distance3 != '' && is_numeric( $review_distance3 ) ) {
            $res_ctx->load_settings_raw( 'review_distance3', $review_distance3 . 'px' );
        }
        ...
        if( is_plugin_active('td-subscription/td-subscription.php') && !empty( has_filter('td_composer_map_exclusive_label_array', 'td_subscription::add_exclusive_label_settings') ) ) {
            ...
            $excl_show3 = $res_ctx->get_shortcode_att('excl_show_3');
            $res_ctx->load_settings_raw( 'excl_show_3', $excl_show3 );
            if( $excl_show3 == '' ) {
                $res_ctx->load_settings_raw( 'excl_show_3', 'inline-block' );
            }
            ...
            $res_ctx->load_settings_raw( 'excl_txt_3', $res_ctx->get_shortcode_att('excl_txt_3') );
           ...
           $excl_margin3 = $res_ctx->get_shortcode_att('excl_margin_3');
            $res_ctx->load_settings_raw( 'excl_margin_3', $excl_margin3 );
            if( $excl_margin3 != '' && is_numeric( $excl_margin3 ) ) {
                $res_ctx->load_settings_raw( 'excl_margin_3', $excl_margin3 . 'px' );
            }
            ...
            $excl_padd3 = $res_ctx->get_shortcode_att('excl_padd_3');
            $res_ctx->load_settings_raw( 'excl_padd_3', $excl_padd3 );
            if( $excl_padd3 != '' && is_numeric( $excl_padd3 ) ) {
                $res_ctx->load_settings_raw( 'excl_padd_3', $excl_padd3 . 'px' );
            }
            ...
            $excl_border3 = $res_ctx->get_shortcode_att('all_excl_border_3');
            $res_ctx->load_settings_raw( 'all_excl_border_3', $excl_border3 );
            if( $excl_border3 != '' && is_numeric( $excl_border2 ) ) {
                $res_ctx->load_settings_raw( 'all_excl_border_3', $excl_border3 . 'px' );
            }
            ...
            $res_ctx->load_settings_raw( 'all_excl_border_style_3', $res_ctx->get_shortcode_att('all_excl_border_style_3') );
            ...
            $excl_radius_3 = $res_ctx->get_shortcode_att('excl_radius_3');
            $res_ctx->load_settings_raw( 'excl_radius_3', $excl_radius_3 );
            if( $excl_radius_3 != '' && is_numeric( $excl_radius_3 ) ) {
                $res_ctx->load_settings_raw( 'excl_radius_3', $excl_radius_3 . 'px' );
            }
            ...
            $res_ctx->load_settings_raw( 'excl_color_3', $res_ctx->get_shortcode_att('excl_color_3') );
            ...
            $res_ctx->load_settings_raw( 'excl_color_h_3', $res_ctx->get_shortcode_att('excl_color_h_3') );
            ...
            $res_ctx->load_settings_raw( 'excl_bg_3', $res_ctx->get_shortcode_att('excl_bg_3') );
            ...
            $res_ctx->load_settings_raw( 'excl_bg_h_3', $res_ctx->get_shortcode_att('excl_bg_h_3') );
           ...
           $excl_border_color3 = $res_ctx->get_shortcode_att('all_excl_border_color_3');
            $res_ctx->load_settings_raw( 'all_excl_border_color_3', $excl_border_color3 );
            if( $excl_border_color3 == '' ) {
                $res_ctx->load_settings_raw( 'all_excl_border_color_3', '#000' );
            }
            ...
            $res_ctx->load_settings_raw( 'excl_border_color_h_3', $res_ctx->get_shortcode_att('excl_border_color_h_3') );


            $res_ctx->load_font_settings( 'f_excl_1' );
            $res_ctx->load_font_settings( 'f_excl_2' );
            $res_ctx->load_font_settings( 'f_excl_3' );
        }
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>                
				...
				/* @image_alignment3 */
				body .$unique_block_class .td_module_flex_8 .entry-thumb {
				...
				/* @image_height3 */
				body .$unique_block_class .td_module_flex_8 .td-image-wrap {
				...
				/* @video_icon3 */
				body .$unique_block_class .td_module_flex_8 .td-video-play-ico {
					width: @video_icon3;
					height: @video_icon3;
				...
				/* @image_width3 */
				body .$unique_block_class .td_module_flex_8 {
					width: @image_width3;
				}
				...
				/* @meta_width3 */
				body .$unique_block_class .td_module_flex_8 .td-module-meta-info {
					width: @meta_width3;
				}
				...
				/* @art_title3 */
				body .$unique_block_class .td_module_flex_8 .tdb-module-title-wrap {
					margin: @art_title3;
				}
				...
				/* @art_title_padd3 */
				body .$unique_block_class .td_module_flex_8 .entry-title {
				...
				/* @auth_date_padding3 */
				body .$unique_block_class .td_module_flex_8 .td-editor-date {
				...
				body .$unique_block_class .td_module_flex_8 .td-post-category {
				...
				/* @show_cat3 */
				body .$unique_block_class .td_module_flex_8 .td-post-category:not(.td-post-extra-category) {
					display: @show_cat3;
				}
				...
				/* @show_author3 */
				body .$unique_block_class .td_module_flex_8 .td-post-author-name {
				...
				/* @show_date3 */
				body .$unique_block_class .td_module_flex_8 .td-post-date,
				body .$unique_block_class .td_module_flex_8 .td-post-author-name span {
					display: @show_date3;
				}
				...
				/* @show_review3 */
				body .$unique_block_class .td_module_flex_8 .entry-review-stars {
				...
				/* @review_size3 */
				body .$unique_block_class .td_module_flex_8 .td-icon-star,
                body .$unique_block_class .td_module_flex_8 .td-icon-star-empty,
                body .$unique_block_class .td_module_flex_8 .td-icon-star-half {
					font-size: @review_size3;
				}
				/* @review_distance3 */
				body .$unique_block_class .td_module_flex_8 .entry-review-stars i {
					margin-right: @review_distance3;
				}
				body .$unique_block_class .td_module_flex_8 .entry-review-stars i:last-child {
				    margin-right: 0;
				}
				...
				/* @f_meta3 */
				body .$unique_block_class .td_module_flex_8 .td-editor-date,
				body .$unique_block_class .td_module_flex_8 .td-editor-date .entry-date,
				body .$unique_block_class .td_module_flex_8 .td-module-comments a {
					@f_meta3
				}
                ...
                /* @excl_show_3 */
                .$unique_block_class .td_module_flex_8.td-module-exclusive .td-module-title a:before {
                    display: @excl_show_3;
                }
                /* @excl_txt_1 */
                .$unique_block_class .td_module_flex_6.td-module-exclusive .td-module-title a:before {
                ...
                /* @all_excl_border_3 */
                .$unique_block_class .td_module_flex_8.td-module-exclusive .td-module-title a:before {
                    border: @all_excl_border_3 @all_excl_border_style_3 @all_excl_border_color_3;
                }
                /* @excl_radius_1 */
                .$unique_block_class .td_module_flex_6.td-module-exclusive .td-module-title a:before {
                ...
                /* @excl_color_h_3 */
                .$unique_block_class .td_module_flex_8.td-module-exclusive:hover .td-module-title a:before {
                    color: @excl_color_h_3;
                }
                /* @excl_bg_1 */
                .$unique_block_class .td_module_flex_6.td-module-exclusive .td-module-title a:before {
                ...
                /* @excl_border_color_h_3 */
                .$unique_block_class .td_module_flex_8.td-module-exclusive:hover .td-module-title a:before {
                    border-color: @excl_border_color_h_3;
                }
                /* @f_excl_1 */
                .$unique_block_class .td_module_flex_6.td-module-exclusive .td-module-title a:before {
                    @f_excl_1
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            foreach ( $posts as $post ) {
                ...
                $td_module_flex_8 = new td_module_flex_8($post, $this->get_all_atts());
                $buffy .= $td_module_flex_8->render($post_count, __CLASS__);
