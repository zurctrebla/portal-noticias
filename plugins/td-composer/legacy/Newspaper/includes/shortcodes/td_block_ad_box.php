...
class td_block_ad_box extends td_block {
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				/* @ad_border_radius_all_device */
				.$unique_block_class .td_spot_img_all img,
				.$unique_block_class .td_spot_img_tl img,
				.$unique_block_class .td_spot_img_tp img,
				.$unique_block_class .td_spot_img_mob img {
				    border-radius: @ad_border_radius_all_device;
				}
				/* @ad_border_size_all_device */
				.$unique_block_class .td_spot_img_all img,
				.$unique_block_class .td_spot_img_tl img,
				.$unique_block_class .td_spot_img_tp img,
				.$unique_block_class .td_spot_img_mob img {
				    border-width: @ad_border_size_all_device;
				}
				/* @ad_border_description_style_all_device */
				.$unique_block_class .td_spot_img_all img,
				.$unique_block_class .td_spot_img_tl img,
				.$unique_block_class .td_spot_img_tp img,
				.$unique_block_class .td_spot_img_mob img {
				    border-style: @ad_border_description_style_all_device;
				}
				
				/* @ad_box_description_border_color_all_device */
				.$unique_block_class .td_spot_img_all img{
				    border-color: @ad_box_description_border_color_all_device;
				}
				/* @ad_box_description_border_color_tab_land */
				.$unique_block_class .td_spot_img_tl img{
				    border-color: @ad_box_description_border_color_tab_land;
				}
				/* @ad_box_description_border_color_tab_portret */
				.$unique_block_class .td_spot_img_tp img{
				    border-color: @ad_box_description_border_color_tab_portret;
				}
				/* @ad_box_description_border_color_phone */
				.$unique_block_class .td_spot_img_mob img{
				    border-color: @ad_box_description_border_color_phone;
				}
    ...
    static function cssMedia( $res_ctx ) {
        ...
        /*-- BORDER RADIUS -- */
        $ad_border_radius_all_device = $res_ctx->get_shortcode_att('ad_border_radius_all_device');
        $res_ctx->load_settings_raw( 'ad_border_radius_all_device', $ad_border_radius_all_device );
        if( $ad_border_radius_all_device != '' && is_numeric( $ad_border_radius_all_device ) ) {
            $res_ctx->load_settings_raw( 'ad_border_radius_all_device', $ad_border_radius_all_device . 'px' );
        }

        /*-- BORDER SIZE -- */
        $ad_border_size_all_device = $res_ctx->get_shortcode_att('ad_border_size_all_device');
        $res_ctx->load_settings_raw( 'ad_border_size_all_device', $ad_border_size_all_device );
        if( $ad_border_size_all_device != '' && is_numeric( $ad_border_size_all_device ) ) {
            $res_ctx->load_settings_raw( 'ad_border_size_all_device', $ad_border_size_all_device . 'px' );
        }

        /*-- BORDER STYLE -- */
        $ad_border_description_style_all_device = $res_ctx->get_shortcode_att('ad_border_description_style_all_device');
        $res_ctx->load_settings_raw( 'ad_border_description_style_all_device', $ad_border_description_style_all_device );
        if( $ad_border_description_style_all_device != '' && is_numeric( $ad_border_description_style_all_device ) ) {
            $res_ctx->load_settings_raw( 'ad_border_description_style_all_device', $ad_border_description_style_all_device . 'px' );
        }

        /*-- BORDER COLOR -- */
        // All devices
        $ad_box_description_border_color_all_device = $res_ctx->get_shortcode_att('ad_box_description_border_color_all_device');
        $res_ctx->load_settings_raw( 'ad_box_description_border_color_all_device', $ad_box_description_border_color_all_device );
        if( $ad_box_description_border_color_all_device != '' && is_numeric( $ad_box_description_border_color_all_device ) ) {
            $res_ctx->load_settings_raw( 'ad_box_description_border_color_all_device', $ad_box_description_border_color_all_device . 'px' );
        }
        // Tablet landscape
        $ad_box_description_border_color_tab_land = $res_ctx->get_shortcode_att('ad_box_description_border_color_tab_land');
        $res_ctx->load_settings_raw( 'ad_box_description_border_color_tab_land', $ad_box_description_border_color_tab_land );
        if( $ad_box_description_border_color_tab_land != '' && is_numeric( $ad_box_description_border_color_tab_land ) ) {
            $res_ctx->load_settings_raw( 'ad_box_description_border_color_tab_land', $ad_box_description_border_color_tab_land . 'px' );
        }
        // Tablet portrait
        $ad_box_description_border_color_tab_portret = $res_ctx->get_shortcode_att('ad_box_description_border_color_tab_portret');
        $res_ctx->load_settings_raw( 'ad_box_description_border_color_tab_portret', $ad_box_description_border_color_tab_portret );
        if( $ad_box_description_border_color_tab_portret != '' && is_numeric( $ad_box_description_border_color_tab_portret ) ) {
            $res_ctx->load_settings_raw( 'ad_box_description_border_color_tab_portret', $ad_box_description_border_color_tab_portret . 'px' );
        }
        // Phone
        $ad_box_description_border_color_phone = $res_ctx->get_shortcode_att('ad_box_description_border_color_phone');
        $res_ctx->load_settings_raw( 'ad_box_description_border_color_phone', $ad_box_description_border_color_phone );
        if( $ad_box_description_border_color_phone != '' && is_numeric( $ad_box_description_border_color_phone ) ) {
            $res_ctx->load_settings_raw( 'ad_box_description_border_color_phone', $ad_box_description_border_color_phone . 'px' );
        }
