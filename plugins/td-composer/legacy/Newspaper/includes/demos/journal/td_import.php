...
$td_cloud_post_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/journal/pages/post_cloud_template.txt',
...
$td_cloud_cat_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/journal/pages/cat_cloud_template.txt',
...
$td_cloud_global_author_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/journal/pages/author_cloud_template.txt',
...
$td_cloud_search_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/journal/pages/search_cloud_template.txt',
...
$td_cloud_404_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/journal/pages/404_cloud_template.txt',
    'template_type' => '404',
));
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/journal/pages/homepage.txt',
...
$td_footertemplate_id = td_demo_content::add_page(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/journal/pages/footer-template.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
...
td_demo_content::add_post(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/journal/pages/post_default.txt',
