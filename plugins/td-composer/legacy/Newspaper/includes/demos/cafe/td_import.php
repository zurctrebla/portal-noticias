...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/cafe/pages/homepage.txt',
...
$td_menupage_id = td_demo_content::add_page(array(
    'title' => 'Menu',
    'file' => TDC_PATH_LEGACY . '/includes/demos/cafe/pages/menu.txt',
...
$td_coffeepage_id = td_demo_content::add_page(array(
    'title' => 'Coffee',
    'file' => TDC_PATH_LEGACY . '/includes/demos/cafe/pages/coffee.txt',
    'template' => 'page-pagebuilder-title.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => 'no_sidebar',
    'homepage' => false
...
$td_pastrypage_id = td_demo_content::add_page(array(
    'title' => 'Pastry',
    'file' => TDC_PATH_LEGACY . '/includes/demos/cafe/pages/pastry.txt',
    'template' => 'page-pagebuilder-title.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => 'no_sidebar',
    'homepage' => false
...
$td_dessertspage_id = td_demo_content::add_page(array(
    'title' => 'Desserts',
    'file' => TDC_PATH_LEGACY . '/includes/demos/cafe/pages/desserts.txt',
    'template' => 'page-pagebuilder-title.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => 'no_sidebar',
    'homepage' => false
...
td_demo_content::add_post(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/cafe/pages/post_default.txt',
...
td_demo_content::add_post(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/cafe/pages/post_default_receipes.txt',
    'categories_id_array' => array($demo_cat_2_id,$demo_cat_3_id,$demo_cat_4_id,$demo_cat_5_id),
    'featured_image_td_id' => 'td_pic_6'
));
