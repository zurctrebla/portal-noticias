...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/law_firm/pages/homepage.txt',
...
$td_ourPeoplePage_id = td_demo_content::add_page(array(
    'title' => 'Our people',
    'file' => TDC_PATH_LEGACY . '/includes/demos/law_firm/pages/our-people.txt',
...
$td_ourExpertisePage_id = td_demo_content::add_page(array(
    'title' => 'Our expertise',
    'file' => TDC_PATH_LEGACY . '/includes/demos/law_firm/pages/our-expertise.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
...
$td_letsConnectPage_id = td_demo_content::add_page(array(
    'title' => 'Let\'s connect',
    'file' => TDC_PATH_LEGACY . '/includes/demos/law_firm/pages/lets-connect.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
...
$td_footerTemplate_id = td_demo_content::add_page(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/law_firm/pages/footer-template.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
