...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/ink/pages/home.txt',
...
$td_artistspage_id = td_demo_content::add_page(array(
    'title' => 'The artists',
    'file' => TDC_PATH_LEGACY . '/includes/demos/ink/pages/the-artists.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
...
$td_shoppage_id = td_demo_content::add_page(array(
    'title' => 'The shop',
    'file' => TDC_PATH_LEGACY . '/includes/demos/ink/pages/the-shop.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
...
$td_bookingpage_id = td_demo_content::add_page(array(
    'title' => 'Booking',
    'file' => TDC_PATH_LEGACY . '/includes/demos/ink/pages/booking.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
...
$td_footertemplate_id = td_demo_content::add_page(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/ink/pages/footer-template.txt',
