...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/showcase/pages/homepage.txt',
...
$td_themespage_id = td_demo_content::add_page(array(
    'title' => 'Themes',
    'file' => TDC_PATH_LEGACY . '/includes/demos/showcase/pages/themes.txt',
...
$td_aboutpage_id = td_demo_content::add_page(array(
    'title' => 'About us',
    'file' => TDC_PATH_LEGACY . '/includes/demos/showcase/pages/about-us.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
...
$td_contactpage_id = td_demo_content::add_page(array(
    'title' => 'Contact',
    'file' => TDC_PATH_LEGACY . '/includes/demos/showcase/pages/contact.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
...
$td_footertemplate_id = td_demo_content::add_page(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/showcase/pages/footer-template.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'homepage' => false
));
