...
td_demo_misc::add_ad_image('custom_ad_1', 'td_fast_ad');
td_demo_misc::add_ad_image('sidebar', 'td_fast_sidebar_ad');
...
$td_cloud_cat_template_id = td_demo_content::add_cloud_template(array(
    'title' => 'Category Cloud Template - Fast News',
    'file' => TDC_PATH_LEGACY . '/includes/demos/fast/pages/cat_cloud_template.txt',
...
$td_cloud_post_template_id = td_demo_content::add_cloud_template(array(
    'title' => 'Single Cloud Template - Fast News',
    'file' => TDC_PATH_LEGACY . '/includes/demos/fast/pages/post_cloud_template.txt',
...
$td_cloud_global_author_template_id = td_demo_content::add_cloud_template(array(
    'title' => 'Author Cloud Template - Fast News',
    'file' => TDC_PATH_LEGACY . '/includes/demos/fast/pages/author_cloud_template.txt',
...
$td_cloud_global_404_template_id = td_demo_content::add_cloud_template(array(
    'title' => '404 Cloud Template - Fast News',
    'file' => TDC_PATH_LEGACY . '/includes/demos/fast/pages/404_cloud_template.txt',
    'template_type' => '404',
));
...
$td_cloud_global_search_template_id = td_demo_content::add_cloud_template(array(
    'title' => 'Search Cloud Template - Fast News',
    'file' => TDC_PATH_LEGACY . '/includes/demos/fast/pages/search_cloud_template.txt',
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/fast/pages/homepage.txt',
...
$td_footerpage_id = td_demo_content::add_page(array(
    'title' => 'Footer',
    'file' => TDC_PATH_LEGACY . '/includes/demos/fast/pages/footer.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
...
td_demo_content::add_post(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/fast/pages/post_default.txt',
    'categories_id_array' => array($demo_cat_2_id,$demo_cat_3_id,$demo_cat_4_id,$demo_cat_5_id,$demo_cat_6_id,$demo_cat_7_id,$demo_cat_8_id,$demo_cat_9_id,$demo_cat_10_id,$demo_cat_11_id,$demo_cat_12_id,$demo_cat_13_id,$demo_cat_14_id),
