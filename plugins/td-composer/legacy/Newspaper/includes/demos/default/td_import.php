...
$td_homepage_blog_id = td_demo_content::add_page(array(
    'title' => 'Homepage - Blog',
    'file' => TDC_PATH_LEGACY . '/includes/demos/default/pages/homepage_blog.txt',
    'template' => 'page-pagebuilder-latest.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '4',
    'homepage' => false,
...
$td_homepage_video_id = td_demo_content::add_page(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/default/pages/homepage_video.txt',
    'template' => 'page-pagebuilder-latest.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '10',
    'homepage' => false,
...
$td_homepage_newsmag_id = td_demo_content::add_page(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/default/pages/homepage_newsmag.txt',
    'template' => 'page-pagebuilder-latest.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '1',
    'homepage' => false
));
