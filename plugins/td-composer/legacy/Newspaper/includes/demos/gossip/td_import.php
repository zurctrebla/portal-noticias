...
//menu background
td_demo_misc::update_background_header('td_header_bg_image');
...
$td_cloud_cat_template_id = td_demo_content::add_cloud_template(array(
    'title' => 'Category Cloud Template - Gossip',
    'file' => TDC_PATH_LEGACY . '/includes/demos/gossip/pages/cat_cloud_template.txt',
...
$td_cloud_post_template_id = td_demo_content::add_cloud_template(array(
    'title' => 'Single Cloud Template - Gossip',
    'file' => TDC_PATH_LEGACY . '/includes/demos/gossip/pages/post_cloud_template.txt',
...
$td_cloud_global_author_template_id = td_demo_content::add_cloud_template(array(
    'title' => 'Author Cloud Template - Gossip',
    'file' => TDC_PATH_LEGACY . '/includes/demos/gossip/pages/author_cloud_template.txt',
...
$td_cloud_global_404_template_id = td_demo_content::add_cloud_template(array(
    'title' => '404 Cloud Template - Gossip',
    'file' => TDC_PATH_LEGACY . '/includes/demos/gossip/pages/404_cloud_template.txt',
    'template_type' => '404',
));
...
$td_cloud_global_search_template_id = td_demo_content::add_cloud_template(array(
    'title' => 'Search Cloud Template - Gossip',
    'file' => TDC_PATH_LEGACY . '/includes/demos/gossip/pages/search_cloud_template.txt',
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/gossip/pages/homepage.txt',
...
$td_footerpage_id = td_demo_content::add_page(array(
    'title' => 'Footer',
    'file' => TDC_PATH_LEGACY . '/includes/demos/gossip/pages/footer.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
...
td_demo_content::add_post(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/gossip/pages/post_default.txt',
