...
$td_about_page = td_demo_content::add_page(array(
    'title' => 'About me',
    'file' => TDC_PATH_LEGACY . '/includes/demos/craft_ideas/pages/about.txt',
...
$td_contact_page = td_demo_content::add_page(array(
    'title' => 'Contact',
    'file' => TDC_PATH_LEGACY . '/includes/demos/craft_ideas/pages/contact.txt',
    'template' => 'page.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => '',
    'homepage' => false
...
$td_homepage_page = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/craft_ideas/pages/homepage.txt',
...
td_demo_content::add_post(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/craft_ideas/pages/post_default.txt',
