...
$td_homepage_page = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/construction/pages/homepage.txt',
...
$td_about_page = td_demo_content::add_page(array(
    'title' => 'About',
    'file' => TDC_PATH_LEGACY . '/includes/demos/construction/pages/about.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => '',
    'homepage' => false
...
$td_services_page = td_demo_content::add_page(array(
    'title' => 'Services',
    'file' => TDC_PATH_LEGACY . '/includes/demos/construction/pages/services.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => '',
    'homepage' => false
...
$td_projects_page = td_demo_content::add_page(array(
    'title' => 'Projects',
    'file' => TDC_PATH_LEGACY . '/includes/demos/construction/pages/projects.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => '',
    'homepage' => false
...
$td_contact_page = td_demo_content::add_page(array(
    'title' => 'Contact',
    'file' => TDC_PATH_LEGACY . '/includes/demos/construction/pages/contact.txt',
    'template' => 'page-pagebuilder-overlay.php',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => '',
    'homepage' => false
...
$td_footertemplate_id = td_demo_content::add_page(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/construction/pages/footer-template.txt',
