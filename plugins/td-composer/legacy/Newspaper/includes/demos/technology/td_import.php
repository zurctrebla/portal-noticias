...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => TDC_PATH_LEGACY . '/includes/demos/technology/pages/homepage.txt',
...
$td_pricingpage_id = td_demo_content::add_page(array(
    'title' => 'Pricing',
    'file' => TDC_PATH_LEGACY . '/includes/demos/technology/pages/pricing.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
...
$td_customerspage_id = td_demo_content::add_page(array(
    'title' => 'Customers',
    'file' => TDC_PATH_LEGACY . '/includes/demos/technology/pages/customers.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => 'no_sidebar',
    'homepage' => false
...
$td_demopage_id = td_demo_content::add_page(array(
    'title' => 'Demo',
    'file' => TDC_PATH_LEGACY . '/includes/demos/technology/pages/demo.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => 'no_sidebar',
    'homepage' => false
...
$td_newspage_id = td_demo_content::add_page(array(
    'title' => 'News',
    'file' => TDC_PATH_LEGACY . '/includes/demos/technology/pages/news.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => 'no_sidebar',
    'homepage' => false
...
$td_footerpage_id = td_demo_content::add_page(array(
    'title' => 'Footer',
    'file' => TDC_PATH_LEGACY . '/includes/demos/technology/pages/footer.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => 'no_sidebar',
    'homepage' => false
...
td_demo_content::add_post(array(
    ...
    'file' => TDC_PATH_LEGACY . '/includes/demos/technology/pages/post_default.txt',
