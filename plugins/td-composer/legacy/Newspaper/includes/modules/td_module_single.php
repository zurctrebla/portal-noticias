        ...
        $buffy .= '<div class="td-post-sharing-top">';
            if( td_util::get_option('tds_top_like_show') == 'show' ) {
                $buffy .= '<div class="td-post-sharing-classic">';
                    $buffy .= '<iframe title="topFacebookLike" frameBorder="0" src="' . td_global::$http_or_https . '://www.facebook.com/plugins/like.php?href=' . $this->href . '&amp;layout=button_count&amp;show_faces=false&amp;width=105&amp;action=like&amp;colorscheme=light&amp;height=21" style="border:none; overflow:hidden; width:auto; height:21px; background-color:transparent;"></iframe>';
                $buffy .= '</div>';
            }
    ...
    function get_social_sharing_bottom() {
        ...
        $buffy .= '<div class="td-post-sharing-bottom">';
            ...
            if( td_util::get_option('tds_bottom_like_show') != 'hide' ) {
                $buffy .= '<div class="td-post-sharing-classic">';
                    $buffy .= '<iframe title="bottomFacebookLike" frameBorder="0" src="' . td_global::$http_or_https . '://www.facebook.com/plugins/like.php?href=' . $this->href . '&amp;layout=button_count&amp;show_faces=false&amp;width=105&amp;action=like&amp;colorscheme=light&amp;height=21" style="border:none; overflow:hidden; width:auto; height:21px; background-color:transparent;"></iframe>';
                $buffy .= '</div>';
            }
