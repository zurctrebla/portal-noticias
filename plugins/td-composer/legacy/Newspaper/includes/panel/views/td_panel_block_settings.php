...
<?php echo td_panel_generator::box_start('Category tag on Modules/Blocks', false); ?>
    ...
    <div class="td-box-row">
        <div class="td-box-description td-box-full">
            ...
            <p>From here you can show or hide the category tag from modules. <?php echo ('enabled' !== td_util::get_option('tds_white_label')) ? '<a target="_blank" href="http://forum.tagdiv.com/category-tag-on-modulesblocks/" >  Read more about modules</a>' : '' ?> </p>
        </div>
        <div class="td-box-row-margin-bottom"></div>
    </div>
...
<!-- generated css -->
<?php echo td_panel_generator::box_start('Inline CSS', false ); ?>

<!-- minify inline css -->
<div class="td-box-row">
    <div class="td-box-description" style="width: 400px;">
        <span class="td-box-title">MINIFY INLINE CSS</span>
        <p>Enabling this option will minify the inline CSS generated by our theme and plugins.</p>
    </div>
    <div class="td-box-control-full" style="width: 320px;">
        <?php
        echo td_panel_generator::checkbox(
...
<div class="td-box-row">
    <div class="td-box-description" style="width: 400px;">
        <span class="td-box-title">AGGREGATE INLINE CSS</span>
        <p>Enabling this option will aggregate all the inline CSS generated by our theme and plugins and places it in the header.</p>
    </div>
    <div class="td-box-control-full" style="width: 320px;">
        <?php
        echo td_panel_generator::checkbox(
