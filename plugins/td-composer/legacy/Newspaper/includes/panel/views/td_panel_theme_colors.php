...
<?php
    ...
    echo td_panel_generator::ajax_box('ToTop button', array(
        'td_ajax_calling_file' => basename(__FILE__),
        'td_ajax_box_id' => 'td_to_top_colors'
        ), '', 'td_panel_box_to_top_colors'
    );
?>
...
<!-- SIGN IN/JOIN MODAL -->
<?php
if( 'Newspaper' == TD_THEME_NAME && ( defined('TD_STANDARD_PACK') || td_global::is_tdb_registered() ) ) {
