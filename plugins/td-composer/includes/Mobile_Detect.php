...
class Mobile_Detect
{
    ...
    {
        $userAgent = $userAgent ?? $this->userAgent ?? ''; // Ensure $userAgent is a string
    ...
    public function version($propertyName, $type = self::VERSION_TYPE_STRING)
    {
        ...
        // Ensure $this->userAgent is a string
        $userAgent = $this->userAgent ?? ''; // Default to an empty string if $this->userAgent is null
        ...
        if ( isset($properties[$propertyName]) ) {
            ...
            foreach ($properties[$propertyName] as $propertyMatchString) {
                ...
                preg_match(sprintf('#%s#is', $propertyPattern), $userAgent, $match);
