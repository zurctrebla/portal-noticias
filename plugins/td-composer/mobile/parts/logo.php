...
$td_header_logo_mob_width = td_util::get_option('tds_logo_menu_upload_mob_width') ? td_util::get_option('tds_logo_menu_upload_mob_width') : '';
$td_header_logo_mob_height = td_util::get_option('tds_logo_menu_upload_mob_height') ? td_util::get_option('tds_logo_menu_upload_mob_height') : '';
...
$td_mobile_customLogo_width = td_util::get_option('tds_logo_menu_upload_width') ? td_util::get_option('tds_logo_menu_upload_width') : '';
$td_mobile_customLogo_height = td_util::get_option('tds_logo_menu_upload_height') ? td_util::get_option('tds_logo_menu_upload_height') : '';
...
$logo_image_size = ' width="' . $td_mobile_customLogo_width . '"' . ' height="' . $td_mobile_customLogo_height . '"';

// specific Mobile Theme options
if(!empty($td_header_logo_mob)) {
    $td_mobile_customLogo = $td_header_logo_mob;
    $logo_image_size = ' width="' . $td_header_logo_mob_width . '"' . ' height="' . $td_header_logo_mob_height . '"';
}
