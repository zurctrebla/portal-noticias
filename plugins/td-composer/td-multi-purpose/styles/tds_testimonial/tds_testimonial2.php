...
class tds_testimonial2 extends td_style {
	...
	private function get_css() {
		...
		$raw_css =
			"<style>
				...
				/* @quote_color */
				body .$unique_style_class.tds-testimonial2 .tdm-icon-quote-left {
				    color: @quote_color;
				}
    ...
    static function cssMedia( $res_ctx ) {
        ...
        // quote color
        $res_ctx->load_settings_raw( 'quote_color', $res_ctx->get_style_att( 'quote_color', __CLASS__ ) );
