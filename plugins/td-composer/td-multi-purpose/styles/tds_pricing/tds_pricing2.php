...
class tds_pricing2 extends td_style {
    ...
    private function get_css() {
		...
		$raw_css =
			"<style>
				...
				.$unique_style_class.tds-pricing2 div.tdm-pricing-header {
				    @header_color_gradient
				}
				/* @header_color */
				.$unique_style_class.tds-pricing2 div.tdm-pricing-header {
				...
				/* @header_featured_color_gradient */
				$unique_block_class.tdm-pricing-featured .$unique_style_class.tds-pricing2 .tdm-pricing-header {
				    @header_featured_color_gradient
				}
				/* @header_featured_color */
				$unique_block_class.tdm-pricing-featured .$unique_style_class.tds-pricing2 .tdm-pricing-header {
				    background: @header_featured_color;
				}
				/* @title_color */
				.$unique_style_class .tdm-pricing-title {
				    color: @title_color;
				}
				/* @price_color */
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $res_ctx->load_color_settings( 'header_color', 'header_color', 'header_color_gradient', '', '', __CLASS__ );

        // header featured background color
        $res_ctx->load_color_settings( 'header_featured_color', 'header_featured_color', 'header_featured_color_gradient', '', '', __CLASS__ );
