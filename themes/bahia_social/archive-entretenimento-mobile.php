    ...
    <div class="container">
        ...
        <div class="main-interno">
            ...
            <div class="filtros-resultado-busca" style="text-align: center; line-height: 30px; border-bottom: none;">
                <a href="/entretenimento" class="ativo" style="color: #15559e; width: 100%; border-right: none;">ENTRETENIMENTO</a>
            </div>
            ...
            <div style="float: left; margin-top: 2%; position: absolute; border-bottom: 2px solid rgba(34,36,38,.15); width: 35%"></div>
             ...
             <div class="circular ui icon top pointing dropdown button btnDropdownCategorias" style="left: 43.5%; margin-top: -10px !important; position: absolute; float: left;">
                 ...
                 <div class="menu" >
                     <div class="<?php if($category == "quem_indica"){echo "active";}?> item"><a style="color: #545454;" href="?category=quem_indica">QUEM INDICA</a></div>
                     <div class="<?php if($category == "comportamento"){echo "active";}?> item"><a style="color: #545454;" href="?category=comportamento">COMPORTAMENTO</a></div>
                     <div class="<?php if($category == "lugar_legal"){echo "active";}?> item"><a style="color: #545454;" href="?category=lugar_legal">LUGAR LEGAL</a></div>
                     <div class="<?php if($category == "gente_boa"){echo "active";}?> item"><a style="color: #545454;" href="?category=gente_boa">GENTE BOA</a></div>
                 </div>
             </div>
            ...
            if($category == "estatisticas") {
                //include("page-apuracao2016-mobile.php");
            } else {
