 ...
 *              _wp_attached_file).
 *
 *              Chamadores em producao (bahia_refactor): o tema nao resolve anexo por URL, mas
 *              varios plugins ATIVOS chamam attachment_url_to_postid() em caminhos quentes --
 *              wordpress-seo (class-wpseo-image-utils, class-sitemap-image-parser), wp-smushit,
