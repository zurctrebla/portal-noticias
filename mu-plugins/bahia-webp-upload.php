...
final class Bahia_WebP_Upload {
    ...
    public static function init() {
        ...
        // NAO ha filtro de remocao aqui, e isso e deliberado: o Offload monta a lista do que
        // sai a partir de `extra_info['objects']`, onde o `bahia_original` ja foi registrado no
        // upload. Medido em 25/08 desligando o nosso filtro: o `bahia_original` continua entrando
        // na lista e o bucket sai limpo. Um filtro proprio aqui seria codigo morto — e foi, por
        // uma rodada inteira, dando falsa sensacao de conserto.
    }
